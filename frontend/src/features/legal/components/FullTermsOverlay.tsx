...
import { TERMS_JOB_SEEKERS } from '../data/jobSeekerTerms';
import { TERMS_EMPLOYERS } from '../data/employerTerms';
...
export default function FullTermsOverlay({ activeTab, onClose }: FullTermsOverlayProps) {
