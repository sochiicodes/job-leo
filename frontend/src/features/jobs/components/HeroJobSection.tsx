...
export const HeroJobSection = () =>{
    return(
        <section className="relative py-16 px-6 bg-linear-to-br from-slate-900 via-slate-800 via-60% to-slate-700 w-full">
            ...
            <div className="relative z-10 flex flex-col gap-4  text-white/90 max-w-4xl m-auto">
                <div className="flex flex-col gap-1 md:items-center">
                    {/* <h1 className="text-[12px] uppercase sm:hidden ">Find your next great role</h1> */}
                    <h1 className="text-2xl md:text-3xl font-bold">Find your next great role</h1>
