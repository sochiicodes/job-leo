...
import { TERMS_JOB_SEEKERS } from '../../legal/data/jobSeekerTerms';
import { TERMS_EMPLOYERS } from '../../legal/data/employerTerms';
...
export default function TermsSection({ activeTab, onTabChange, onViewFullTerms }: TermsSectionProps) {
