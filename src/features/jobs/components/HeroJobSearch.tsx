...
const HeroJobSearch = () =>{
    ...
    return(
        <form className="bg-white rounded-xl shadow-2xl p-1.5 sm:p-2 flex flex-col md:flex-row items-stretch gap-2 text-[#1C1A17]">
            ...
            <button 
                type="submit"
                className="flex items-center bg-brand-600 text-slate-900 px-6 gap-2 font-bold rounded-lg"
            >  
