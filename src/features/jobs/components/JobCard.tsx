...
const JobCard = ({ viewMode}: JobCardProps) => {
    const isAvailable = true;
    const isList = viewMode

    return (
        <section
            className={`relative bg-white rounded-3xl border border-slate-100 p-6 shadow-sm hover:shadow-2xl hover:border-brand-200 transition-all group min-w-0 ${
                isList ? "w-full" : "w-full flex flex-col"
            }`}
        >
